...
public class Level : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        GameOver.Getinstanca().GameOver_ekran(false);
    }
    ...
    private void KreirajCev(float visina, float pozicijaX, bool donjaCev) {
        ...
        teloCevi.position = new Vector3(pozicijaX, teloCeviYpozicija);// postavljamo telo cevi na ekran ali nismo podesili visinu i sirinu
